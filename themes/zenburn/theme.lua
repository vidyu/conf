...
themes_dir = os.getenv("HOME") .. "/.config/awesome/themes/zenburn"

theme.wallpaper = themes_dir .. "/arch-background.jpg"
...
-- {{{ Misc
theme.awesome_icon           = themes_dir .. "/arch-icon.png"
